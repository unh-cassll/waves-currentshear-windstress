...
if p(1) >= 0
    ...
    if B_high < degree_of_saturation
        ...
        k_new = logspace(log10(dk),log10(k_high_old),2^nextpow2(length(k_rad_m)))';

        B_k_new = 10.^interp1(log10(k_rad_m),log10(B_k),log10(k_new));
        D_k_new = 10.^interp1(log10(k_rad_m),log10(D_k),log10(k_new));
